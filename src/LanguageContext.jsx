...
const STRINGS = {
  en: {
    ...
    hero_cv: 'Download CV',
    hero_badge: 'Available for work',    copy_title: 'Click to copy email',
    copied: 'Copied!',
    ...
    contact_copy: 'Copy',
    contact_open: 'Open',
    contact_cta_title: 'Have something in mind?',
    contact_cta_desc: 'My inbox is always open. Just say hi.',
    contact_cta_work: 'See my work',
  ...
  id: {
    ...
    hero_cv: 'Unduh CV',
    hero_badge: 'Terbuka untuk kerja sama',
    ...
    contact_copy: 'Salin',
    contact_open: 'Buka',
    contact_cta_title: 'Punya sesuatu di pikiran?',
    contact_cta_desc: 'Kotak masuk saya selalu terbuka. Sapa saja.',
    contact_cta_work: 'Lihat karya saya',
